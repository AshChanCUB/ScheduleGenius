...
function PreferencesPage() {
  ...
  useEffect(() => {
    if (savedPreferences && Object.keys(savedPreferences).length > 0) {
      ...
      setPomodoroSettings(
        savedPreferences.pomodoroSettings || pomodoroSettings
      );
    } else {
      fetchEventTypes();
    }
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <div className="inner-box-preference">
                ...
                <tr key={index}>
                  ...
                  <td>
                    <select
                      value={pref.priority}
                      onChange={(e) =>
                        handlePriorityChange(pref.type, e.target.value)
                      }
                    >
                  ...
                  <td>
                    <select
                      value={pref.label}
                      onChange={(e) =>
                        handleLabelChange(pref.type, e.target.value)
                      }
                    >
                      <option value="Lectures and Classes">
                  ...
                  <td>
                    <select
                      ...
                      onChange={(e) =>
                        handleFocusLevelChange(pref.type, e.target.value)
                      }
                    >
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) =>
                        handleEstimatedDurationChange(pref.type, e.target.value)
                      }
                      min="0"
                    />
                  </td>
            ...
            {Object.keys(labelWeights).map((label, index) => (
              <div key={index}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleLabelWeightChange(label, e.target.value)
                    }
                    step="0.01"
                    min="0"
                    max="1"
              ...
              <div className="flex-container">
                ...
                <div style={{ marginTop: "10px" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handlePomodoroSettingChange("breakLength", e.target.value)
                    }
                    style={{ marginLeft: "10px" }}
                  />
                </div>
